...
$faq_query = "SELECT * FROM faq ORDER BY id ASC";
...
<body class="template-color-1">
                    ...
                    <div class="col-md-12">
                        <div class="frequently-content">
                            <div class="frequently-desc">
                                ...
                                <p>Find quick answers to common questions about our car parts marketplace, Wrenchy chatbot, and how to connect with trusted dealers.</p>
                            </div>
                        </div>
    ...
    <div id="accordion">
        ...
        <?php while ($faq = mysqli_fetch_assoc($faq_result)): ?>
            <div class="card <?= $index === 1 ? 'actives' : '' ?>">
                <div class="card-header" id="heading<?= $index ?>">
                    <h5 class="mb-0">
                        <a href="javascript:void(0)" class="<?= $index !== 1 ? 'collapsed' : '' ?>" data-toggle="collapse" data-target="#collapse<?= $index ?>" aria-expanded="<?= $index === 1 ? 'true' : 'false' ?>" aria-controls="collapse<?= $index ?>">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-widgets">
                                            <ul>
                                                ...
                                                <li><a  href="https://www.google.com/maps/place/Airport+Residential+Area,+Accra,+Ghana/@5.5915,-0.1777,17z" target="_blank">Site Map</a></li>
                                            </ul>
                                        </div>
                                    </div>
